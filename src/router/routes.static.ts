export const staticRoutes: AppRoute.RowRoute[] = [
  ...
  },
  {
    ...
    'meta.title': '本地存储',
    'meta.requiresAuth': true,
    'meta.icon': 'icon-park-outline:save',
    'componentPath': '/demo/localStorage/index.vue',
    'id': 241,
    'pid': 13,
  },
  {
    'name': 'reverseColor',
    'path': '/demo/reverseColor',
    'meta.title': '颜色反转',
    'meta.requiresAuth': true,
    'meta.icon': 'icon-park-outline:save',
    'componentPath': '/demo/reverseColor/index.vue',
    'id': 242,
    'pid': 13,
  },
  {
    ...
    'meta.requiresAuth': true,
    'meta.icon': 'icon-park-outline:save',
    'componentPath': '/demo/typed/index.vue',
    'id': 243,
    'pid': 13,
  },
  {
    'name': 'card-animation',
    'path': '/demo/card-animation',
    'meta.title': '卡片动画',
    'meta.requiresAuth': true,
    'meta.icon': 'icon-park-outline:save',
    'componentPath': '/demo/cardAnimation/index.vue',
    'id': 244,
    'pid': 13,
  },
  {
